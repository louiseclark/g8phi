...

{
  ...
  ///////////////////////////////Load Variables
  RF->LoadVariable("MissM[0.2,0.29]");//should be same name as variable in tree  
  ...
  RF->Factory("CBShape::Signal( MissM, SIMm[0.24,0.22,0.26], SIMw[0.01,0.001,0.02], SIMa[1,0,2], SIMn[10,5,150] )");
...
//  RF->Factory("Chebychev::BG(MissM,{a0[-0.1,-1,1],a1[0.1,-1,1],a2[0,-1,1]})");
  ...
  chain.Add("/home/louise/g8_phi/haspect/Events/Projects/g8phi/convert_output/filepKm_21.root");
