...
ClassImp(SKNewPDF) 
 ...
 SKNewPDF::SKNewPDF(const char *name, const char *title, 
   ...
   cosThetaKpGJ("cosThetaKpGJ","cosThetaKpGJ",this,_cosThetaKpGJ),
   phiKpGJ("phiKpGJ","phiKpGJ",this,_phiKpGJ),
 ...
 { 
   MakeSets();
   cosThetaKpGJ.SetName(_cosThetaKpGJ.GetName());
   phiKpGJ.SetName(_phiKpGJ.GetName());
 ...
 SKNewPDF::SKNewPDF(const SKNewPDF& other, const char* name) :  
   ...
   cosThetaKpGJ("cosThetaKpGJ",this,other.cosThetaKpGJ),
   phiKpGJ("phiKpGJ",this,other.phiKpGJ),
 ...
 { 
   MakeSets();
   cosThetaKpGJ.SetName(other.cosThetaKpGJ.GetName());
   phiKpGJ.SetName(other.phiKpGJ.GetName());
...
void SKNewPDF::MakeSets(){
   fProxSet.push_back(&cosThetaKpGJ);
   fProxSet.push_back(&phiKpGJ);
 ...
 { 
   ...
   Double_t cosSqTheta = cosThetaKpGJ * cosThetaKpGJ;
   Double_t sinSqTheta = 1 - cosSqTheta;
   Double_t theta = TMath::ACos(cosThetaKpGJ);
   Double_t sin2theta = TMath::Sin(2.0 * theta);
   Double_t cos2theta = TMath::Cos(2.0 * theta);
   Double_t cos2phi = TMath::Cos(2.0 * phiKpGJ);
   Double_t sin2phi = TMath::Sin(2.0 * phiKpGJ);
   Double_t cosphi = TMath::Cos(phiKpGJ);
   Double_t sinphi = TMath::Sin(phiKpGJ);
...
// ENTER IDENTICAL EXPRESSION TO evaluate() IN TERMS OF MC VARIABLE ARGUMENTS HERE
  Double_t mccosThetaKpGJ=fMCVar[0];
  Double_t mcphiKpGJ=fMCVar[1];
  Double_t mcPHI=fMCVar[2];
  Double_t mcpol=fMCVar[3];
  Int_t mcpolState=fMCCat[0];
  
   Double_t cosSqTheta = mccosThetaKpGJ * mccosThetaKpGJ;
   Double_t sinSqTheta = 1 - cosSqTheta;
   Double_t theta = TMath::ACos(mccosThetaKpGJ);
   Double_t sin2theta = TMath::Sin(2.0 * theta);
   Double_t cos2theta = TMath::Cos(2.0 * theta);
   Double_t cos2phi = TMath::Cos(2.0 * mcphiKpGJ);
   Double_t sin2phi = TMath::Sin(2.0 * mcphiKpGJ);
   Double_t cosphi = TMath::Cos(mcphiKpGJ);
   Double_t sinphi = TMath::Sin(mcphiKpGJ);
   Double_t sqrt2 = TMath::Sqrt(2.0);
