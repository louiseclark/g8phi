...
//root --hsfit FitHSAsymmetryBins.C --SKNewPDF.cxx
{
  ...
  ///////////////////////////////Load Variables
  RF->LoadVariable("cosThetaKpGJ[-1,1]");//going to fit this
  RF->LoadVariable("phiKpGJ[-3.14,3.14]");
 ...
 // TFile *fileMC=new TFile("/home/louise/g8_phi/haspect/Events/Projects/g8phi/convert_output_MC/file_all.root");
  ...
  RF->Factory("SKNewPDF::SDMEFit(cosThetaKpGJ,phiKpGJ,PHI,pol,polState,rho000[0.3,-0.5,0.5],Rerho010[0.0,-0.5,0.5],rho01m1[0.0,-0.5,0.5],rho111[0.0,-0.5,0.5],rho100[0.0,-0.5,0.5],Rerho110[0.0,-0.5,0.5],rho11m1[0.0,-0.5,0.5],Imrho210[0.0,-0.5,0.5],Imrho21m1[0.0,-0.5,0.5])");
