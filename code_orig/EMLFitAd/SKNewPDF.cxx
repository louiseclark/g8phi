...
ClassImp(SKNewPDF) 
 ...
 SKNewPDF::SKNewPDF(const char *name, const char *title, 
   ...
   cosThetaKpAd("cosThetaKpAd","cosThetaKpAd",this,_cosThetaKpAd),
   phiKpAd("phiKpAd","phiKpAd",this,_phiKpAd),
 ...
 { 
   MakeSets();
   cosThetaKpAd.SetName(_cosThetaKpAd.GetName());
   phiKpAd.SetName(_phiKpAd.GetName());
 ...
 SKNewPDF::SKNewPDF(const SKNewPDF& other, const char* name) :  
   ...
   cosThetaKpAd("cosThetaKpAd",this,other.cosThetaKpAd),
   phiKpAd("phiKpAd",this,other.phiKpAd),
 ...
 { 
   MakeSets();
   cosThetaKpAd.SetName(other.cosThetaKpAd.GetName());
   phiKpAd.SetName(other.phiKpAd.GetName());
...
void SKNewPDF::MakeSets(){
   fProxSet.push_back(&cosThetaKpAd);
   fProxSet.push_back(&phiKpAd);
 ...
 { 
   ...
   Double_t cosSqTheta = cosThetaKpAd * cosThetaKpAd;
   Double_t sinSqTheta = 1 - cosSqTheta;
   Double_t theta = TMath::ACos(cosThetaKpAd);
   Double_t sin2theta = TMath::Sin(2.0 * theta);
   Double_t cos2theta = TMath::Cos(2.0 * theta);
   Double_t cos2phi = TMath::Cos(2.0 * phiKpAd);
   Double_t sin2phi = TMath::Sin(2.0 * phiKpAd);
   Double_t cosphi = TMath::Cos(phiKpAd);
   Double_t sinphi = TMath::Sin(phiKpAd);
...
// ENTER IDENTICAL EXPRESSION TO evaluate() IN TERMS OF MC VARIABLE ARGUMENTS HERE
  Double_t mccosThetaKpAd=fMCVar[0];
  Double_t mcphiKpAd=fMCVar[1];
  Double_t mcPHI=fMCVar[2];
  Double_t mcpol=fMCVar[3];
  Int_t mcpolState=fMCCat[0];
  
   Double_t cosSqTheta = mccosThetaKpAd * mccosThetaKpAd;
   Double_t sinSqTheta = 1 - cosSqTheta;
   Double_t theta = TMath::ACos(mccosThetaKpAd);
   Double_t sin2theta = TMath::Sin(2.0 * theta);
   Double_t cos2theta = TMath::Cos(2.0 * theta);
   Double_t cos2phi = TMath::Cos(2.0 * mcphiKpAd);
   Double_t sin2phi = TMath::Sin(2.0 * mcphiKpAd);
   Double_t cosphi = TMath::Cos(mcphiKpAd);
   Double_t sinphi = TMath::Sin(mcphiKpAd);
   Double_t sqrt2 = TMath::Sqrt(2.0);
