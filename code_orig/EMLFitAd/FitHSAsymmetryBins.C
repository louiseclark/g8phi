...
//root --hsfit FitHSAsymmetryBins.C --SKNewPDF.cxx
{
  ...
  RF->SetOutDir("out_var_tE/"); //give output directory
  //RF->SetBinnedFit();

  ///////////////////////////////Load Variables
  RF->LoadVariable("cosThetaKpAd[-1,1]");//going to fit this
  RF->LoadVariable("phiKpAd[-3.14,3.14]");
  ...
  Double_t binLimits[] = {0.1, 0.45, 0.59, 0.79, 1.6};
 ...
 // TFile *fileMC=new TFile("/home/louise/g8_phi/haspect/Events/Projects/g8phi/convert_output_MC/file_all.root");
  ...
  RF->Factory("SKNewPDF::SDMEFit(cosThetaKpAd,phiKpAd,PHI,pol,polState,rho000[0.3,-0.5,0.5],Rerho010[0.0,-0.5,0.5],rho01m1[0.0,-0.5,0.5],rho111[0.0,-0.5,0.5],rho100[0.0,-0.5,0.5],Rerho110[0.0,-0.5,0.5],rho11m1[0.0,-0.5,0.5],Imrho210[0.0,-0.5,0.5],Imrho21m1[0.0,-0.5,0.5])");
  
  // Feed back in the values I get after fitting with default starting values (1.0 bin)
  //RF->Factory("SKNewPDF::SDMEFit(cosThetaKpHel,phiKpHel,PHI,pol,polState,rho000[0.267,-0.5,0.5],Rerho010[0.014,-0.5,0.5],rho01m1[-0.015,-0.5,0.5],rho111[-0.005,-0.5,0.5],rho100[-0.077,-0.5,0.5],Rerho110[0.053,-0.5,0.5],rho11m1[0.0,-0.5,0.5],Imrho210[0.062,-0.5,0.5],Imrho21m1[0.092,-0.5,0.5])");
