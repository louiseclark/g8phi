...
#ifndef MChistogrammer_h
#define MChistogrammer_h
...
class MChistogrammer : public TSelector, public THSOutput {
public :
  ...
  //data members for reading weights
   ...
   MChistogrammer(TTree * /*tree*/ =0) { }
   virtual ~MChistogrammer() {SafeDelete(fWeights);  }
...
//Add THSHisto functions
   ...
   ClassDef(MChistogrammer,0);

};

#endif

#ifdef MChistogrammer_cxx
void MChistogrammer::Init(TTree *tree)
{
...
#endif // #ifdef MChistogrammer_cxx
