...

{
  ...
  THSsPlot* RF=new THSsPlot("pKpKm_all");
  RF->SetOutDir("out/");
 // RF->SetBinnedFit(); //For parameter fits do binned chi2
  ///////////////////////////////Load Variables
  RF->LoadVariable("MKpKm[1.0,1.045]");//should be same name as variable in tree  
  ...
  chain.Add("/home/louise/g8_phi/haspect/Events/Projects/g8phi/convert_output1/filepKpKm_all.root");
