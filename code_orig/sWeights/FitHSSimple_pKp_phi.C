...

{
  ...
  THSsPlot* RF=new THSsPlot("pKp_all");
  RF->SetOutDir("out/");
 // RF->SetBinnedFit(); //For parameter fits do binned chi2
  ...
  chain.Add("/home/louise/g8_phi/haspect/Events/Projects/g8phi/convert_output1/filepKp_all.root");
  ...
  RF->GetWeights()->Save();
  RF->SaveHists("out/HistspKp_all.root");
